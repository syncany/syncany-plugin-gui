 ...
 *
 */
public class SelectLocalFolderPanel extends WizardPanelComposite {
	private Text localDir;
	private Label introductionLabel;
	private Label messageLabel;

	public SelectLocalFolderPanel(WizardDialog wizardParentDialog, Composite parent, int style) {
	...
	public boolean isValid() {
		...
		case "watch":
			...
			if (new File(folder, ".syncany").exists()) {
				return true;
			}
			else {
